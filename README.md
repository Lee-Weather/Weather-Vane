...
| `Summarizer` | Generates Chinese summaries (Short summaries and Detailed technical intros) using DeepSeek API |
...
### 3. Manual Run Example

```bash
# Directly run script (without Claude Code)
...
| `TELEGRAM_BOT_TOKEN` | ❌ | Telegram Bot Push |
